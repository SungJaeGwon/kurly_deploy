...
export default function PostcodeDeliveryComponent () {
    ...
    const deliveryUpdateList=()=>{
        if(selector.signIn.로그인정보!==null){        
            ...
            axios({
                url:'https://gwonsj94.co.kr/kurly_green/green_kurly_delivery_table_select.php',
                method: 'POST',
                data: formData
            })
            .then((res)=>{
    ...
    const onClickDeliveryUpdateSave=(e)=>{
        ...
        axios({
            url: 'https://gwonsj94.co.kr/kurly_green/green_kurly_delivery_table_update.php',
            method:'POST',
            data: formData
        })
        .then((res)=>{
    ...
    const onClickDeliveryDelete=(e)=>{
        ...
        axios({
            url: 'https://gwonsj94.co.kr/kurly_green/green_kurly_delivery_table_delete.php',
            method:'POST',
            data: formData
        })
        .then((res)=>{
    ...
    const onClickSave=(e)=>{
        ...
        axios({
            url:'https://gwonsj94.co.kr/kurly_green/green_kurly_delivery_table_insert.php',
            method: 'POST',
            data: formData
        })
        .then((res)=>{
